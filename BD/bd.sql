...
INSERT INTO `cliente` VALUES (1,'Josue','Nájera','Jiménez','13/05/2003','123','123',1,'5525142581','noseques',1234);
/*!40000 ALTER TABLE `cliente` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `historico_transaccion`
--

DROP TABLE IF EXISTS `historico_transaccion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `historico_transaccion` (
  `id` int NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `idTransaccion_idx` (`idTransaccion`),
  CONSTRAINT `idTransaccion` FOREIGN KEY (`idTransaccion`) REFERENCES `transacción` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `historico_transaccion`
--

LOCK TABLES `historico_transaccion` WRITE;
/*!40000 ALTER TABLE `historico_transaccion` DISABLE KEYS */;
/*!40000 ALTER TABLE `historico_transaccion` ENABLE KEYS */;
UNLOCK TABLES;
